 ...
 */
static unsigned int * xxtea_to_uint_array(const unsigned char * data, size_t len, int inc_len, size_t * out_len)
{
	unsigned int *out;
	size_t i, n;
 ...
 * Caller is responsible for freeing the returned buffer.
 */
static unsigned char * xxtea_to_ubyte_array(const unsigned int * data, size_t len, int inc_len, size_t * out_len)
{
	unsigned char *out;
	size_t i, m, n;
 ...
 */
static unsigned int * xxtea_uint_decrypt(unsigned int * data, size_t len, unsigned int * key)
{
	size_t n = len - 1;
